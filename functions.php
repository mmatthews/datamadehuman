...
if ( ! function_exists( 'dmh_setup' ) ) :
	...
	function dmh_setup() {
		 ...
		 * If you're building a theme based on dmh, use a find and replace
		...
		register_nav_menus( array(
			//'primary-menu' => esc_html__( 'Primary', 'dmh' ),
			//'mobile-menu' => esc_html__( 'Mobile', 'dmh' ),			
			'footer-menu' => esc_html__( 'Footer', 'dmh' )	
		) );
...
function dmh_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'dmh' ),
 ...
 */
require get_template_directory() . '/inc/gform-endpoint.php';